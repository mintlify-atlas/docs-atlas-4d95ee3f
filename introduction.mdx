...
description: "bybit-api is a complete Node.js/TypeScript SDK for Bybit REST APIs, WebSocket streams, and WebSocket API — with automatic authentication and 400 req/s rate limits."
---
...
The SDK ships three main client classes. For new integrations, start with `RestClientV5` for REST calls and `WebsocketClient` for streaming.
