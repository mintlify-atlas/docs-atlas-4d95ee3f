---
title: "Configure Logging and Debugging in the bybit-api SDK"
sidebarTitle: "Logging"
description: "Set up custom logging in bybit-api by implementing trace, info, and error methods, using DefaultLogger, or routing output to pino or winston."
---
