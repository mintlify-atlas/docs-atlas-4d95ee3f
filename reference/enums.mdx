---
title: "Enums and Constants Reference for bybit-api"
sidebarTitle: "Enums"
...
| `INCORRECT_API_KEY_PERMISSIONS` | 10005 | API key lacks the required permission for this action. Also aliased as `V5_API_KEY_PERMISSION_DENIED`. |
